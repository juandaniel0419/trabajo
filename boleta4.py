...
print("arroz con pollo ",   cantidad_de_pernos  ,"     "    ,pu_perno  ,"   "   ,total1)
print("gaseosa         ",   cantidad_de_clavos        ,"     "    ,pu_clavos,"   "   ,total2)
print("ceviche         ",   cantidad_de_calaminas ,"     "    ,pu_calaminas,"   "   ,total3)
